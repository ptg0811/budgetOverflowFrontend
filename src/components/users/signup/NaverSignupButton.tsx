...
const NaverSignupButton = () => {
  ...
  const handleNaverSignup = () => {
    window.location.href = `https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=${process.env.REACT_APP_NAVER_CLIENT_ID}&state=${naverStateString}&redirect_uri=https://budget-overflow-frontend-dgcf528dj-ptg0811.vercel.app/naverlogin`;
  };
